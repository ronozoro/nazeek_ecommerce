              ...
              <Grid columns={2} >
                ...
                <Grid.Column style={{ marginLeft: 31 }} width={10}>
                  ...
                  <Grid columns={1} >
                    ...
                    <Grid.Row>
                      <Link to='/profile_edit'> <Button style={{}} content='Update Profile' type='button' primary /></Link>
                      <Link to='/change_password'><Button style={{ margin: 'auto' }} content='Change Password' type='button' primary /></Link>
                    </Grid.Row>
                  </Grid>
                </Grid.Column>
              </Grid>
